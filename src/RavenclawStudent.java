public class RavenclawStudent extends HowardsStudent {
    ...
    public void compareRavenclaw (RavenclawStudent ravenclawStudent) {
        ...
        if (ability1 > ability2) {
            System.out.printf("Когтевранец %s лучше, чем студент %s: %d VS %d%n", getName(), ravenclawStudent.getName(), ability1, ability2);
        } else if (ability2 > ability1) {
            System.out.printf("Когтевранец %s лучше, чем студент %s: %d VS %d%n", ravenclawStudent.getName(), getName(), ability2, ability1);
        } else {
            System.out.printf("Когтевранец %s такой же, чем студент %s: %d VS %d%n", ravenclawStudent.getName(), getName(), ability2, ability1);
        }
    }
